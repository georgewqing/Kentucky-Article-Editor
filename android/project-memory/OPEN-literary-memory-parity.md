# OPEN: 文学 Agent 记忆能力对齐（Win Round H / M1–M4 → Android）

> **状态：OPEN / 未开始移植**  
> **创建**：2026-08-11  
> **Win 指纹**：`toolApi: "2026-08-11-j"`（完整重启后验证）  
> **需求原文**：[`../../win/project-memory/REQ-literary-agent-capability-upgrade.md`](../../win/project-memory/REQ-literary-agent-capability-upgrade.md)  
> **Win 会话交接**：[`../../win/project-memory/SESSION-TOOL-FEEDBACK.md`](../../win/project-memory/SESSION-TOOL-FEEDBACK.md)  
> **Win 自测清单**：[`../../win/project-memory/AGENT-TOOL-TEST-BASELINE.md`](../../win/project-memory/AGENT-TOOL-TEST-BASELINE.md) §四  
> **总清单 / 门禁**：[`../../win/project-memory/AGENT-TOOL-FEEDBACK.md`](../../win/project-memory/AGENT-TOOL-FEEDBACK.md)  
> **产品决策摘录**：[`../../win/project-memory/product-decisions.md`](../../win/project-memory/product-decisions.md)（文学记忆文件 / 快照上限）  
> **总 OPEN 进度板**：[`OPEN-agent-tool-feedback-parity.md`](./OPEN-agent-tool-feedback-parity.md)（H1–H4 勾选）  
> **移植手册**：[`PORTING-WIN-TO-ANDROID.md`](./PORTING-WIN-TO-ANDROID.md) §阶段 G · Round H

本文是 **Android 移植契约书**：Win 已实现的文学记忆层（状态表 / 伏笔 / 声线 / 场景快照 / 素材译名校验）的文件映射、工具清单、门禁、schema、issue kinds、L5、验收步骤与 Android 特有坑。  
**勿 import `win/`**；在 `android/src/ai-runtime/` 对照重写，IO 一律 `WorkspaceIo`。
...
全部通过后：将本文件状态改为 **CLOSED**，`OPEN-agent-tool-feedback-parity.md` 中 H1–H4 打 ✅，`changelog.md` 留一条。
...
- 总 Agent 反馈 OPEN：[`OPEN-agent-tool-feedback-parity.md`](./OPEN-agent-tool-feedback-parity.md)  

...
import { notePointerType } from '@/hooks/useSecondaryClick'
...
function DialogueGraphInner({ tabId }: { tabId: string }) {
  ...
  const onInspectorSashDown = (e: ReactPointerEvent): void => {
    e.preventDefault()
  ...
  return (
    <div className="dialogue-graph-editor">
      ...
      <div className="dialogue-graph-body">
        <div
          className="dialogue-graph-canvas rf-host"
          onPointerDownCapture={(e) => notePointerType(e)}
        >
          <ReactFlow
            nodes={nodes}
            edges={displayEdges}
        ...
        <div
          ...
          onPointerDown={onInspectorSashDown}
          role="separator"

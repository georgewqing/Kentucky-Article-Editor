...
2. **思维导图** — `.kmind` v2 自由白板（React Flow）  
3. **工作台** — 文件夹工作区、设置主题、中英 i18n  

| 文档 | 内容 |
|------|------|
| [architecture.md](./architecture.md) | 技术栈、目录、数据流、关键模块 |
| [product-decisions.md](./product-decisions.md) | 需求 grill 结论（已定稿，勿擅自推翻） |
| [changelog.md](./changelog.md) | 按时间线的功能与修复记录 |
| [gotchas.md](./gotchas.md) | 踩坑与约束（Electron prompt、TipTap、MiniMap 等） |
| [how-to-run.md](./how-to-run.md) | 本地运行 / 常见启动问题 |

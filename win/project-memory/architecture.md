...
> **当前**：Win **0.3.0** · `toolApi: 2026-08-14-a` · 2026-08-14。  
...
- 安卓平板为**独立软件根** `../android/`（Capacitor 0.2.0），不在本 Electron 树内换 Platform。移植扫描：[`../../android/project-memory/PORTING-WIN-TO-ANDROID.md`](../../android/project-memory/PORTING-WIN-TO-ANDROID.md)。
